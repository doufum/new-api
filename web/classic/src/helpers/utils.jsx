...
import { normalizeManagementLogoPath } from './brand';
import { resolveSystemName } from './branding';
...
export function getSystemName() {
  ...
  return resolveSystemName(system_name);
}

export function getLogo() {
  return normalizeManagementLogoPath(localStorage.getItem('logo'));
}
