  ...
  const sectionDefs: SectionDef[] = [
    {
      key: 'chat',
      title: t('Console'),
      description: t('Primary model testing workspace'),
      modules: [
        {
          key: 'playground',
          title: t('Playground'),
    ...
    },
    {
      key: 'console',
      title: t('Workspace'),
      description: t('API keys and usage inspection tools'),
      modules: [
        {
          key: 'detail',
          title: t('Console'),
          description: t('User workspace overview'),
        },
        {
          key: 'token',
          title: t('API Keys'),
          description: t('API credential management'),
        },
        {
          key: 'log',
          title: t('Usage Logs'),
    ...
    },
    {
      key: 'personal',
      title: t('Account'),
      description: t('Profile and wallet settings'),
      modules: [
        {
          key: 'topup',
          title: t('Wallet'),
