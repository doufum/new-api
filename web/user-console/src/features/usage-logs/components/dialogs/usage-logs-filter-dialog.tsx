...
import { useUsageLogsRoute } from '../../route-context'
...
export function UsageLogsFilterDialog({
  ...
  const { search, goToSection } = useUsageLogsRoute()
  ...
  const handleApply = useCallback(() => {
    ...
    goToSection(logCategory, {
      ...searchParams,
      ...filterParams,
    })
    onFilterChange?.(filters)
    setOpen(false)
  }, [filters, goToSection, logCategory, onFilterChange, searchParams, setOpen])
  ...
  const handleReset = useCallback(() => {
    ...
    setOpen(false)
  }, [goToSection, logCategory, onFilterChange, setOpen])
