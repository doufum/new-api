...
import { normalizeUserConsoleLogo } from "@/lib/brand-assets";
import "@/lib/dayjs";
import { applyFaviconToDom } from "@/lib/dom-utils";
import { handleServerError } from "@/lib/handle-server-error";
import { resolveSystemName } from "@/lib/branding";
import { getUserConsoleMountConfig } from "@/config/app-base";
...
const mountConfig = getUserConsoleMountConfig(import.meta.env.PROD);
...
const router = createRouter({
  basepath: mountConfig.routerBasePath,
  routeTree,
  context: { queryClient },
  ...
  try {
    ...
    try {
      ...
      if (saved) {
        ...
        const cachedLogo = normalizeUserConsoleLogo(s?.logo);
    ...
    getStatus()
      .then((s) => {
        const systemLogo = normalizeUserConsoleLogo(
