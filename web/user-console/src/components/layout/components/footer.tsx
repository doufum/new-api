      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            href: '/workspace/docs/tools/claude-code',
          },
          {
            text: t('footer.columns.docs.links.apiDocs'),
            href: '/workspace/docs/api-reference/openai-compatible',
          },
        ],
      },
      {
  ...
  return (
    ...
    >
      <div className='mx-auto max-w-6xl px-6 py-12 md:py-16'>
        ...
        {/* Bottom section */}
        <div className='border-border/30 mt-12 flex items-center justify-center border-t pt-6'>
          <ProjectAttribution currentYear={currentYear} />
        </div>
      </div>
    </footer>
