...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/console': { section: 'console', module: 'detail' },
  '/workspace/keys': { section: 'console', module: 'token' },
  '/workspace/logs': { section: 'console', module: 'log' },
  '/workspace/tasks': { section: 'console', module: 'task' },
  '/account/wallet': { section: 'personal', module: 'topup' },
  '/account/profile': { section: 'personal', module: 'personal' },
