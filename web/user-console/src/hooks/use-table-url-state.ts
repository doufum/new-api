...
export type NavigateFn<TSearch extends SearchRecord = SearchRecord> = (opts: {
  search:
    | true
    | TSearch
...
type UseTableUrlStateParams<TSearch extends SearchRecord = SearchRecord> = {
  search: TSearch
...
export function useTableUrlState<TSearch extends SearchRecord = SearchRecord>(
  ...
  const mergeSearchPatch = (prev: TSearch, patch: SearchRecord) =>
    ({ ...prev, ...patch }) as TSearch
